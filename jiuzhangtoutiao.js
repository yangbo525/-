...
添加之后 打开软件 点击我的 往下拉一下 应该就可以添加token了

一天预算2块的样子 

========QuanX=========
[rewrite_local]
https://api.st615.com/v1/user/info\?token=\S+ url script-request-header http://gjds.vip/QX/quantumutilx/jzread.js

hostname = api.st615.com
*/

// [task_local]
// */60 * * * * http://gjds.vip/QX/quantumutilx/jzread.js, tag=九章头条, img-url=circles.hexagongrid.fill.system, enabled=false
